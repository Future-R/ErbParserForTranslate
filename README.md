...
✅ **版本更新**：从新版本游戏中提取增删改的条目，插入到原字典中，这样能保护原本的Key值不被改变；  
...
- [x] **拆判别式**：将提取到的判别式拆开，过滤其中的变量名和数字，只保留"字符串"；
- [x] **字典转换**：将本工具的字典转换成其他工具的字典，或者反过来；
- [x] **安全更新**：版本更新的时候，过时的词条不会删除，而是隐藏；
- [x] **机器翻译**：配置Token来批量机翻（Paratranz其实已经类似的功能，而且不是已经有很多机翻工具了吗）；
